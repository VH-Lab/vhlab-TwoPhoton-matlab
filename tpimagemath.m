function [result,im1,im2] = tpimagemath(dirname, channel, stimcode1, stimcode2, op,plotit,name)
...
[data,t] = tpreaddata(dirname, [interval1; spinterval1; interval2; spinterval2]-starttime,{find(im_outline==1)},0,1);
