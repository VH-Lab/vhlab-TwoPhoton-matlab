function [ims,channels] = tppreview_stdprojection(dirnames, tpparams, channellist, parameters, shortname, dirname)
...
for i=1:length(channels),
	...
	if ~isempty(fnameparameters{i}),
		ims{i} = tp_preview_stdprojection_meat(dirnames,tpparams,{fnameparameters{i}},channel,parameters.firstFrames,parameters.numFrames);
	end;
end;

function im = tp_preview_stdprojection_meat(dirnames,params,fnameparameters,channel,firstFrames,numberFrames)
