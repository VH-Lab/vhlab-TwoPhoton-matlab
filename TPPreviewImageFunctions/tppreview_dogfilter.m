function [ims,channels] = tppreview_filter(dirnames, tpparams, channellist, parameters)
...
for i=1:numberFrames,
	im = cat(3,im,imread(fullfile(dirnames{1},tpfilename(fnameparameters{1},ffile(n(i),1),channel,ffile(n(i),2)))));
end;
...
lowpass_cell_image = imfilter(im, hl,'symmetric');
highpass_cell_image = im - lowpass_cell_image;
im = imfilter(highpass_cell_image, hh, 'symmetric');
