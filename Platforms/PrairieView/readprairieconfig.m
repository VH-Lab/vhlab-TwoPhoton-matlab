...
%  substructures.
%
%  If FILENAME is a directory, then READPRAIRIECONFIG determines
%  the name of the config file.  If FILENAME is a file, then 
...
filename = tpconfigfilename(filename); % get the right file name
