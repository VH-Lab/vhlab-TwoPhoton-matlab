...
tpparams = tpfnameparams(dirname,channel,params);
...
im = double(tpreadframe(dirname,tpparams,1,channel,frame_selection(1)));

for f=frame_selection(2:end)
  im = im+double(tpreadframe(dirname,tpparams,1,channel,f));
end;
