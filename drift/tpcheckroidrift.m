function [im] = tpcheckroidrift(dirname, channel, roirect, roiinds, roix,roiy,roiname, plotit)
...
if isfield(params,'Type'),
	if strcmp(params.Type,'Linescan')|strcmp(params.Type,'linescan'),
        im = tpcheckroidriftls(dirname,channel,roiinds,roix,roiy,roiname,plotit);
		return;
	end;
end;
...
interval = [0 Inf];
	...
	% tpreaddata also performs drift correction
